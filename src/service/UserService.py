...
def addUser(params):
    try:
        ...
        sql = "INSERT INTO [User] (UserId, userName, firstName, lastName, email, phoneNumber, isValidated) \
            VALUES(3, ?, ?, ?, ?, ?, 0)" # id is hardcoded, need to update db to auto increment id
